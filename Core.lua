...
TD.SPECS={
    ...
    destruction={id="destruction",family="warlock",name="Destruction",letter="D",baseCost=70,desc="Very slow fire AoE.",color={1.0,0.4,0.1},specIcon="Interface\\Icons\\Spell_Fire_Immolation",damage={26,31,45},range={85,95,105},cooldown={2.8,2.5,2.2},splash={45,55,70},slowPct=0,slowDur=0,dot=0,upgradeCost={0,45,80}},
    ...
    starfall={id="starfall",family="druid",name="Balance",letter="B",baseCost=65,desc="Pulses ALL in range.",color={1.0,0.6,0.0},specIcon="Interface\\Icons\\Ability_Druid_Starfall",damage={7,9,13},range={100,115,130},cooldown={1.4,1.1,0.8},splash=0,slowPct=0,slowDur=0,dot=0,upgradeCost={0,45,80},pulse=true},
