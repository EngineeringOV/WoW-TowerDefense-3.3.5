...
TD.SPECS={
    ...
    frost={id="frost",family="mage",name="Frost Mage",letter="F",baseCost=40,desc="Strong slow effect.",color={0.3,0.6,1.0},specIcon="Interface\\Icons\\Spell_Frost_FrostBolt02",damage={5,9,14},range={110,120,135},cooldown={1.2,1.0,0.85},splash=0,slowPct={0.4,0.5,0.65},slowDur={1.8,2.2,3.0},dot=0,upgradeCost={0,40,70}},
    ...
    destruction={id="destruction",family="warlock",name="Destruction",letter="D",baseCost=80,desc="Very slow fire AoE.",color={1.0,0.4,0.1},specIcon="Interface\\Icons\\Spell_Fire_Immolation",damage={22,31,45},range={85,95,105},cooldown={2.8,2.5,2.2},splash={45,55,70},slowPct=0,slowDur=0,dot=0,upgradeCost={0,50,90}},
    ...
    starfall={id="starfall",family="druid",name="Balance",letter="B",baseCost=75,desc="Pulses ALL in range.",color={1.0,0.6,0.0},specIcon="Interface\\Icons\\Ability_Druid_Starfall",damage={5,9,13},range={100,115,130},cooldown={1.4,1.1,0.8},splash=0,slowPct=0,slowDur=0,dot=0,upgradeCost={0,50,90},pulse=true},
