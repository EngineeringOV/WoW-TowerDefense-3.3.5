...
TD.SPECS={
    ...
    starfall={id="starfall",family="druid",name="Balance",letter="B",baseCost=65,desc="Pulses ALL in range.",color={1.0,0.6,0.0},specIcon="Interface\\Icons\\Ability_Druid_Starfall",damage={7,9,13},range={120,140,160},cooldown={1.2,0.9,0.6},splash=0,slowPct=0,slowDur=0,dot=0,upgradeCost={0,45,80},pulse=true},
